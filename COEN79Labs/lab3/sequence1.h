...
//
//   void operator +=(const sequence& rhs) **can be void or return sequence, up to programmer.
...
namespace coen79_lab3 {
	...
	double standardDeviation() const;
    private:
	value_type data[CAPACITY]; //sotr each # of sequence in an array
	size_type used; //store size of sequence
	size_type current_index; //keep track of where you are in the sequence
    }; 
